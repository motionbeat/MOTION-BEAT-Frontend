...
//         const streamNickname = JSON.parse(event.stream.connection.data).clientData; // 닉네임 데이터 추출
//         if (!otherVideosRef.current[streamNickname]) {
//           otherVideosRef.current[streamNickname] = videoContainer;
//         } else {
//           otherVideosRef.current[streamNickname].appendChild(videoContainer);
//         }
...
//                       ref={(el) => {
//                         if (el) {
//                           otherVideosRef.current[nickname] = el;
//                           const videoContainer = otherVideosRef.current[nickname];
//                           if (videoContainer && videoContainer.childNodes.length === 0 && otherVideosRef.current[nickname]) {
//                             videoContainer.appendChild(otherVideosRef.current[nickname]);
//                           }
//                         }
//                       }} // 닉네임에 맞는 비디오 컨테이너를 렌더링
//                       className="webCamBoxInner"
//                     />
//                   )}
//                   <p>
